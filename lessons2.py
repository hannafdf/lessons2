...
# 4. Вывести result_sum в консоль. print('Result=', item_1+item_2)
#print(result)
...
#  34. Прибавить 10 к item_3 с присвоением. item_3 = item_3 + 10 т.е. (10+10)
item_3 += 10

#  35. Вывести item_3 в консоль.
print(item_3)

#  36. Отнять 5 от item_3 с присвоением. item_3 = item_3 - 5  т.е. 20-5
item_3 -= 5

#  37. Вывести item_3 в консоль.
print(item_3)

#  38. Умножить item_3 на 3 с присвоением. item_3 = item_3 * 10  т.е. 15*3
item_3 *= 3

#  39. Вывести item_3 в консоль.
print(item_3)

#  40. Разделить item_3 на 2 с присвоением. т.е. 45/2
item_3 /= 2
...
# Boolean -Логический тип данных (bool) (или булевый тип) это примитивный тип данных, который принимает 2 значения
# — истина или ложь. True и False пишутся с большой буквы. Если написать с маленькой true, интерпретатор выдаст ошибку
#
